...
async def about_us_command_callback_query(query: types.CallbackQuery) -> None:
    ...
    await query.message.answer_photo(
        ...
        caption=(
            "Мы — сеть Го-клубов Кыргызстана <b>Sengoku</b>, объединяющая людей, увлечённых древней настольной игрой Го. 🎯<br><br>"
            "<b>✨ Наша миссия:</b> популяризировать игру Го, помогая каждому развивать стратегическое мышление и находить гармонию.<br><br>"
            "Что мы предлагаем:<br>"
            "🎓 <b>Обучение игре Го</b> для новичков и продвинутых игроков.<br>"
            "🧠 <b>Мастер-классы</b> и регулярные занятия для всех возрастов.<br>"
            "🏆 Организацию турниров и участие в международных мероприятиях.<br>"
            "🤝 Уютное сообщество единомышленников, где можно найти друзей и наставников.<br><br>"
